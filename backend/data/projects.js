const projects = [
  {
    ...
    css: ["CSS media queries for responsive design (Desktop and Mobile optimized).", "UX emphasis on accessibility."],
    scss: ["Mixins, Extends, Variables & Functions.", "BEM naming convention.", "7-1 pattern (7 folders, 1 file) SASS directory structure."],
    reactJS: ["Clients can view, make, and pay for appointments.", "Clients can also leave reviews and message the business.", "Admin side created to manage appointments, users, and reviews.", "Calendar made from scratch that displays the entire appointment history.", "Search bar created for easy navigation through available screens.", "Local storage for form data.", "Mapbox.", "Error handling with PropTypes.", "Custom hooks created.", "DRY principle applied."],
  ...
  },
  {
    ...
    html: ["Semantic HTML.", "Consistent, clean code with proper use of white space."],
    css: ["CSS grid used to create a image gallery.", "CSS media queries for responsive design (Desktop and Mobile optimized).", "UX emphasis on accessibility."],
    reactJS: ["SVG animations.", "Mapbox.", "API interaction using CRUD operations via Axios.", "Custom hooks for email validation created.", "DRY principle applied."],
  ...
  },
  {
    ...
    html: ["Semantic HTML.", "Consistent, clean code with proper use of white space."],
    css: ["Animations using keyframes.", "Image gallery created with CSS grid.", "CSS media queries for responsive design (Desktop and Mobile optimized).", "UX emphasis on accessibility."],
  ...
  },
  {
    ...
    abstract: "This application is a simple 1 page HTML design to showcase highlights from my fourth trip to Indonesia",
    ...
    js: ["jQuery for animations.", "Sticky nav with active buttons to navigate throughout the page."],
    security: ["HTTPS."],
  ...
  },
  {
    ...
    html: ["Semantic HTML.", "Consistent, clean code with proper use of white space."],
    css: ["A variety of different layout designs are used.", "CSS grid and flexbox.", "CSS media queries for responsive design (Desktop and Mobile optimized).", "UX emphasis on accessibility."],
  ...
  },
  {
    ...
    html: ["Semantic HTML.", "Consistent, clean code with proper use of white space."],
    css: ["A variety of different layout designs are used.", "CSS grid used to create a image gallery.", "CSS media queries for responsive design (Desktop and Mobile optimized).", "UX emphasis on accessibility."],
  ...
  },
  {
    ...
    html: ["Semantic HTML.", "Consistent, clean code with proper use of white space."],
    css: ["A variety of different layout designs are used.", "Animations using keyframes.", "CSS grid and flexbox.", "CSS media queries for responsive design (Desktop and Mobile optimized).", "UX emphasis on accessibility."],
