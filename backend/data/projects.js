const projects = [
  ...
  },
  {
    name: "Nexter",
    skills: ["HTML5", "CSS3"],
    description__1: "This project was built as part of Jonas Schmedtmann’s advanced CSS course. It focused on concepts including CSS Grid and flexbox, while also offering insight into UX design through picture layering and the photo gallery. This project was focused on SASS.",
    description__2: "This course taught me a lot about both the conceptual side of CSS as well as ways that CSS can be applied to create beautiful websites. In addition, I also got to learn how to use SASS and implement its BEM naming convention.",
    description__3: "The code is fairly standard, with no backend and with all directories (besides the node modules) in the root. HTML was used for content, with a link to fonts and the style sheet. The body is composed of a header, sections & divs, and a footer. The SASS code is all found in one directory, with that being the extent of its organization. The utilization of CSS brings the HTML code to life. This can be seen in the header, cards, and image gallery, which all beautifully visualize the data.",
