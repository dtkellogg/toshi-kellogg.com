    ...
    <section className="skills__container">
      <section className="skills__container--left">
        ...
        <p className="skills__paragraph">
          <span className="skills__paragraph--1 fadeInAnimated--1">
          ...
          <br />
          <br />
          <span className="skills__paragraph--2 fadeInAnimated--2">
          ...
          <br />
          <br />
          <span className="skills__paragraph--3 fadeInAnimated--3">
          ...
          <br />
          <br />
          <span className="skills__paragraph--4 fadeInAnimated--4">
