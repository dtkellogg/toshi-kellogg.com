    ...
    <section className="skills__container">
      <section className="skills__container--left">
        <header className="skills__header fadeInAnimated--0">
          <h1 className="font-size-1">Skills & Experience</h1>
        </header>
        <p className="skills__paragraph">
          <span className="skills__paragraph--1 font-size-3 fadeInAnimated--1">
          ...
          <br />
          <br />
          <span className="skills__paragraph--2 font-size-3 fadeInAnimated--2">
          ...
          <br />
          <br />
          <span className="skills__paragraph--3 font-size-3 fadeInAnimated--3">
          ...
          <br />
          <br />
          <span className="skills__paragraph--4 font-size-3 fadeInAnimated--4">
