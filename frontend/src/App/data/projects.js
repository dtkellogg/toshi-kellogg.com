const projects = [
  ...
  },
  {
    ...
    html: ["Semantic HTML.", "Consistent, clean code with proper use of white space."],
    css: ["Animations using keyframes.", "CSS grid and flexbox.", "CSS media queries for responsive design (Desktop and Mobile views available).", "UX emphasis on accessibility."],
    scss: ["Mixins, Extends, & Variables.", "BEM naming convention.", "7-1 pattern (7 folders, 1 file) SASS directory structure."],
    security: ["HTTPS."],
